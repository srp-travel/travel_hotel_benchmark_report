"""
tab_params.py — Onglet 1 : Configuration des seuils de compétitivité.
"""
...
def render() -> dict[str, float]:
    """
    Affiche le formulaire des seuils.
    Retourne le dict `params` utilisé par get_competitiveness().
    """
    ...
    # Stockage de la politique de référence dans session_state pour tab_report
